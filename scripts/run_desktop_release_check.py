    ...
    *,
    ...
    commands = [
        ...
        CommandSpec(
            ...
            argv=[sys.executable, "-B", "scripts/run_security_checks.py", "--skip-optional"],
            timeout=120,
        ),
        CommandSpec(
            label="desktop_doctor",
            argv=[sys.executable, "-B", "scripts/run_desktop_doctor.py", "--json"],
            timeout=120,
        ),
        CommandSpec(
            label="desktop_completion_audit",
            argv=[sys.executable, "-B", "scripts/run_desktop_completion_audit.py"],
            timeout=120,
        ),
